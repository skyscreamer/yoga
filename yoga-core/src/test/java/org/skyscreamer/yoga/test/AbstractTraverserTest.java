...
{
    protected YogaRequestContext _simpleContext = new YogaRequestContext( "map", new DummyHttpServletRequest(), new DummyHttpServletResponse() );
    ...
    protected void doTraverse( Object instance, String selectorString, ResultTraverser traverser, YogaRequestContext context )
    {
        try
        {
            ...
            _objectTree = _model.getUnderlyingModel();
        }
